...
const SignupForm = () => {
  ...
  return (
    <Form {...form}>
      <div className="sm:w-96 md:w-120 lg:w-140 flex-center flex-col">
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormControl>
                  <Input type='text' placeholder='Enter your name' {...field} className='shad-input' />
                </FormControl>
                <FormMessage />
              </FormItem>
            )}
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormControl>
                  <Input type='email' placeholder='Enter your email' {...field} className='shad-input' />
                </FormControl>
                <FormMessage />
              </FormItem>
            )}
